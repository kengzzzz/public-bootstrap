...
- `pacman -Sy --noconfirm perf elfutils openssl zstd git cmake ninja clang llvm`
- `cd /workspace`
...
- `perf record --pfm-events RETIRED_TAKEN_BRANCH_INSTRUCTIONS:k -a -N -b -c 500009 -o /workspace/propeller.data sleep 1200`
...
- `cd /workspace/llvm-propeller`
- `./build/propeller/generate_propeller_profiles --binary=/workspace/extract_dbg/usr/src/debug/linux-cachyos/vmlinux --profile=/workspace/propeller.data --cc_profile=/workspace/propeller_cc_profile.txt --ld_profile=/workspace/propeller_ld_profile.txt`